---
name: kss-sonnet-low
description: KSS executor — sonnet, low effort. One layer, 1-2 files, copying an existing pattern. Also used for integration (rebase, merge, worktree cleanup). Runs no tests, lint or build.
model: sonnet
effort: low
