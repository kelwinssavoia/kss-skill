---
name: kss-reviewer-sonnet-medium
description: KSS reviewer — sonnet, medium effort, read-only. Reviews one finished ticket's diff and report against the project rules and the FRs it covers, and returns approve or reject with numbered findings. Spawned when models.review maps a review depth to this pair.
model: sonnet
effort: medium
